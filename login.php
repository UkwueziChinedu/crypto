    ...
    try {
        ...
        if ($user && password_verify($password, $user['password_hash'])) {
            ...
            if (!empty($user['two_factor_secret'])) {
                ...
                handleResponse($is_ajax, 'success', "Redirecting...", 'two_factor');
            } else {
                handleResponse($is_ajax, 'success', "Redirecting...", 'dashboard');
            }
        } else {
            ...
            <div class="flex-grow flex items-center justify-center p-8">
                <div class="w-full max-w-md">
                    ...
                    <form id="loginForm" method="POST" action="login" class="space-y-6">
                        ...
                        <!-- Forgot Password -->
                        <div class="flex justify-end">
                            <a href="reset" class="text-sm text-primary">Forgot Password?</a>
                        </div>
